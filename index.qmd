...
Télécharger et observer les données sur les gares françaises en opendata disponbles [ici](https://www.data.gouv.fr/fr/datasets/liste-des-gares/)
...
Encapsuler le code précédent dans une fonction renvoyant les coordonnées d'une gare à partir de la chaîne de caractères du nom de la gare. Faire un test en affichant les coordonnées de la gare de Toulouse-Matabiau.
