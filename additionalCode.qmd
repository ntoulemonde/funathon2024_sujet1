...
On teste l'API avec la fonction et le json, et on regarde le contenu de la réponse de l'API avec la fonction *View*
...
On questionne l'API avec la fonction et le json, et on regarde le contenu de la réponse de l'API avec la fonction *View*
