...
On crée une fonction qui envoie une requête contenant un JSON (en chaine de caractères) à l'endpoint d'une API de TravelTime grâce à la bibliothèque "httr"
...
Après observation du JSON de la réponse, on extrait les données utiles de celui-ci
