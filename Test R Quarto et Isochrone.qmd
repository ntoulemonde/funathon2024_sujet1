...
On crée un dataframe avec tous les éléments pour la cartographie (les noms, les latitudes et les longitudes des villes de départ et d'arrivée, et les émissions de CO2 des lignes associées)
...
```{r}
for (i in nrow(emissionByRouteDf)) {
