...
On crée une fonction qui renvoie le trafic total d'une liaison en 2019 en PKT à partir des deux noms de villes en paramètre
...
getAirTraficBetweenCities <- function(city1, city2){
  ...
  return(as.vector(airTrafic1 + airTrafic2))e
}
```
...
On calcule les émissions de CO2 de avec une estimation des gCO2éq par PKT de [statista](https://www.statista.com/statistics/1113177/co2-emissions-by-airline-europe/)
